...
// PhiClaw: Agent catalog with orchestration instructions
export const PHICLAW_AGENTS_FILENAME = "PHICLAW-AGENTS.md";
...
export type WorkspaceBootstrapFileName =
  ...
  | typeof PHICLAW_AGENTS_FILENAME;
